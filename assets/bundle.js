...
/***/ function(module, exports, __webpack_require__) {
	...
	var wurl = __webpack_require__(160);
	var SpotifyBox = __webpack_require__(161);
	...
	var scope = ['user-read-email', 'user-read-private', 'user-follow-read', 'user-follow-modify'].join(' '); // 需要使用者授予的權限

	ReactDOM.render(React.createElement(SpotifyBox, { clientId: clientId, redirectUri: redirectUri, scope: scope, state: '' }), document.getElementById("spotifyBox"));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var wurl = __webpack_require__(160); // a nodejs version js-url
	...
	module.exports = React.createClass({
	    ...
	    handleLoginRequest: function handleLoginRequest() {
	        var url = function url(clientId, redirectUri, scope, state) {
	            return 'https://accounts.spotify.com/authorize' + '?client_id=' + clientId + '&redirect_uri=' + encodeURIComponent(redirectUri) + '&scope=' + encodeURIComponent(scope) + '&response_type=token' + '&state=' + encodeURIComponent(state);
	        };

	        var style = function style(width, height, top, left) {
	        ...
	        window.open(url(this.props.clientId, this.props.redirectUri, this.props.scope, this.props.state), 'Spotify', style(width, height, left, top));
	    },
	    handleLoginRequestCallback: function handleLoginRequestCallback(event) {
	    ...
	    getUserProfile: function getUserProfile(accessToken) {
	        $.ajax({
	    ...
	    getFollowingList: function getFollowingList(accessToken) {
	        ...
	        var getNextPage = function getNextPage(accessToken, url) {
	    ...
	    handleSearchInputChanged: function handleSearchInputChanged(e) {
	        this.setState({
	            search: {
	    ...
	    getSearchResult: function getSearchResult(accessToken, searchType, searchText) {
	    ...
	    handleFollowRequest: function handleFollowRequest(e) {
	    ...
	    handleUnfollowRequest: function handleUnfollowRequest(e) {
	        console.log('following itemId: ' + e.target.value);
	    ...
	    render: function render() {
	        ...
	        if (this.state.user.loginStatus == false) {
	            return React.createElement(
	                ...
	                React.createElement(
	                    ...
	                    React.createElement(
	                        'p',
	                        null,
	                        'Please login your Spotify Accounts'
	                    ),
	                    React.createElement(
	                        'p',
	                        null,
	                        React.createElement(
	                            'button',
	                            { onClick: this.handleLoginRequest, style: styles.loginButton },
	                            ' Login '
	                        )
	                    )
	                )
	            ...
	            return React.createElement(
	                ...
	                React.createElement(SearchBox, { handleSearchInputChanged: this.handleSearchInputChanged, searchResult: this.state.searchResult, followingList: this.state.followingList, handleFollowRequest: this.handleFollowRequest, handleUnfollowRequest: this.handleUnfollowRequest }),
	                React.createElement('hr', null),
	                React.createElement(FollowingList, { data: this.state.followingList, handleUnfollowRequest: this.handleUnfollowRequest })
	            );
	        }
	    }
	});
	    ...
	    render: function render() {
	        ...
	        var searchResultItem = this.props.searchResult.map(function (item) {
	            ...
	            if (isFollowingList.length > 0) {
	                return React.createElement(
	                    'div',
	                    { key: item.id, className: 'searchResultItemContainer', style: styles.searchResultItemContainer },
	                    React.createElement(
	                        'div',
	                        { className: 'searchResultItemPhoto', style: styles.searchResultItemPhoto },
	                        React.createElement('img', { src: imageUrl, alt: item.name, style: styles.searchResultItemPhotoImage })
	                    ),
	                    React.createElement(
	                        'div',
	                        { className: 'searchResultItemName', style: styles.searchResultItemName },
	                        React.createElement(
	                            'p',
	                            { style: styles.searchResultItemNameTitle },
	                            item.name,
	                            React.createElement(
	                                'span',
	                                { style: styles.tagFollowing },
	                                'following'
	                            ),
	                            React.createElement(
	                                'button',
	                                { onClick: handleUnfollowRequest, value: item.id, style: styles.btnUnfollow },
	                                'unfollow'
	                            )
	                        ),
	                        React.createElement(
	                            ...
	                            React.createElement(
	                                'a',
	                                { href: item.external_urls.spotify, target: '_blank', style: styles.searchResultItemNameHref },
	                                React.createElement('img', { src: 'http://pennstateliveshere.psu.edu/images/play-btn.png' })
	                            )
	                        )
	                    ),
	                ...
	                return React.createElement(
	                    ...
	                    React.createElement(
	                        ...
	                        React.createElement(
	                            ...
	                            React.createElement(
	                                'button',
	                                { onClick: handleFollowRequest, value: item.id, style: styles.btnFollow },
	                                'follow'
	                            )
	                        ),
	                        React.createElement(
	        ...
	        return React.createElement(
	            ...
	            React.createElement(
	                'div',
	                null,
	                React.createElement('input', { type: 'text', placeholder: 'please enter search text', onChange: this.props.handleSearchInputChanged, style: styles.inputBox })
	            ),
	            React.createElement(
	                'h4',
	                null,
	...
	var FollowingList = React.createClass({
	    ...
	    render: function render() {
	        ...
	        var listItem = this.props.data.map(function (item) {
	            ...
	            return React.createElement(
	                'div',
	                { key: item.id, className: 'followingItemContainer', style: styles.followingItemContainer },
	                React.createElement(
	                    'div',
	                    { className: 'followingItemPhoto', style: styles.followingItemPhoto },
	                    React.createElement('img', { src: imageUrl, alt: item.name, style: styles.followingItemPhotoImage })
	                ),
	                React.createElement(
	                    'div',
	                    { className: 'followingItemName', style: styles.followingItemName },
	                    React.createElement(
	                        'p',
	                        { style: styles.followingItemNameTitle },
	                        item.name,
	                        React.createElement(
	                            'button',
	                            { onClick: handleUnfollowRequest, value: item.id, style: styles.btnUnfollow },
	                    ...
	                    React.createElement(
	                        ...
	                        React.createElement(
	                            'a',
	                            { href: item.external_urls.spotify, target: '_blank', style: styles.followingItemNameHref },
	                            React.createElement('img', { src: 'http://pennstateliveshere.psu.edu/images/play-btn.png' })
	                        )
	                    )
	                ),
